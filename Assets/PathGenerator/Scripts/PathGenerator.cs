...
namespace CurvedPathGenertator {
    ...
    public class PathGenerator : MonoBehaviour {
        ...
        public float LineOpacity = 0.7f;                            // Texture opacity
        public float LineSpeed = 10f;                               // Texture scrolling speed
        public float LineTiling = 20f;                              // Y-Axis tiling
        public float LineFilling = 1f;                              // Filling amount of material ( 0 to 1 )
        public int LineRenderQueue = 3000;                          // Render queue
        public Texture2D LineTexture;                               // Line mesh texture

        public List<Vector3> PathList = new List<Vector3>();        // List of path pos
        public List<float> pathLengths = new List<float>();         // List of path length
